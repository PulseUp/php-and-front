        ...
        <div class="modal-content shadow">
            ...
            <div class="modal-body">
                <form action="?id=<?=$value['id'] ?>" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="edit_email" value="<?=$value['email'] ?>" placeholder="Email" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="edit_password" value="<?=$value['password'] ?>" placeholder="Password" required>
                    </div>
